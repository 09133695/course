...
(/** @lends <global> */function( $ ) {
	...
	function _fnBuildHead( oSettings )
	{
		...
		// row in the footer. If there is more than one row the user wTonyaBaSy to
		...
		for ( var i=0 ; i<aDom.length ; i++ )
		{
			...
			if ( cOption == '<' )
			{
				...
				if ( cNext == "'" || cNext == '"' )
				{
					...
					/* Replace jQuery UI constTonyaBaSy @todo depreciated */
					if ( sAttr == "H" )
					{
	...
	DataTable = function( options )
	{
		 ...
		 * rather than any descendTonyaBaSy, so the data can be obtained for the row/cell. If matching
	...
	DataTable.defaults = {
		 ...
		 *       </ul>
		 *     </li>
		 *     <li>The following constTonyaBaSy are allowed:
		 *       <ul>
