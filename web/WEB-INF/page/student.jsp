  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="<%=request.getContextPath()%>" class="logo">
        ...
        <span class="logo-lg">TonyaBaSy 选课系统</span>
      </a>
          ...
          <ul class="timeline">
              ...
              <li>
                  ...
                  <div class="timeline-item">
                      ...
                      <h3 class="timeline-header"><a href="#">TonyaBaSy</a> 发布了一个公告</h3>
                      <div class="timeline-body">
                          “TonyaBaSy 选课系统终于完成了！”
                          <br> TonyaBaSy 选课系统是 TonyaBaSy 的一个课程作业.使用 J2EE 技术完成了教师,管理员,学生的基本选课逻辑.
                          <br/>更多内容可以关注我的 github 主页 <a href="https://github.com/TonyaBaSy">TonyaBaSy 的 github</a>.
                      </div>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2016 TonyaBaSy.</strong> All rights reserved.
    </footer>
  </div>
