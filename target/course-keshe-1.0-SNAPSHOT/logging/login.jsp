...
<body class="login-page">
	...
	<div class="wrapper">
		<div class="container">
            ...
            <div align="center">
                测试账号,账号与密码一致<br/>
                <a class="btn btn-success" style="font-size: 12px">学生: 000010880433</a>
                <a class="btn btn-success" style="font-size: 12px">教师: 67539863</a>
                <a class="btn btn-success" style="font-size: 12px">管理员: 28266345</a>
            </div>
		</div>
	</div>
